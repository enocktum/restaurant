		...
		<div class="wrapper">
			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="logo-brand">
						<a href="http://www.enosoft.tk" target="_blank"><img src="assets/img/enosoft.png" alt="enosoft logo"></a>
					</div><!-- /.logo-brand -->
					<!-- End Logo brand -->
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="index.php">Current Portal</a></li>
					...
					<li>
						...
						<ul class="submenu visible">
							<li><a href="systemhelp.php">System Help</a></li>
			...
			<br/><br/>
				...
				<footer style="text-align:left;" class="navbar navbar-default navbar-fixed-bottom">
					<div style="text-align:center;" class="container-fluid">&copy; <?php echo date("Y");?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="">Restaurant Point of sale</a> 
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Design by <a href="http://www.enosoft.tk" target="_blank">Enosoft Software Solutions</a>.</div>
				</footer>
				<!-- END FOOTER -->
